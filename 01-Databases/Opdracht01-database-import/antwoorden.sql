-- Taak01 - haal de tabel movies op:127.0.0.1/mod_mysql_basic_imdb_movies/movies/		http://localhost/phpmyadmin/index.php?route=/table/sql&db=mod_mysql_basic_imdb_movies&table=movies
